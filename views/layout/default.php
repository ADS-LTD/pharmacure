<html style="overflow: none;overflow: hidden;" onclick="fermerMenu()" lang="fr">
	...
	<body style="overflow-x: none;overflow-x: hidden" onload='display_ct();addTabVentes("Vente","<?=WEBROOT?>Vente/index");
		...
		<?php if(isset($_SESSION['user']) && $_SESSION['user']->Type==5):?>
		...
		<div id="content">
			...
			<tr style=" min-height:100%; padding:0px; border-spacing: 0px; border-collapse: separate;">
				...
				<div id="modules">
						<div class="menutab" cellspacing="10px">	
							...
							<a href="#" name="Vente" onclick='addTab("Vente","<?=WEBROOT?>Vente/index")'>
							<div class="line">
								<div class="back"><div class="vente_img"></div></div>
										<div class="text"><span>Vente<span></div>
							</div>
							</a>
