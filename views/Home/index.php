<?php
    ...
    $link = mysqli_connect("localhost", "root", "","pharmacure");
    mysqli_set_charset($link, "utf8mb4");
    
    $result = mysqli_query($link, "SELECT count(*) FROM client");
    $result1 = mysqli_query($link, "SELECT count(*) FROM produit");
    $result2 = mysqli_query($link, "SELECT count(*) FROM commande");
    $num_rows = mysqli_fetch_row($result)[0];
    $num_rows1 = mysqli_fetch_row($result1)[0];
    $num_rows2 = mysqli_fetch_row($result2)[0];
...
<div class="upper_content">
  <table width="100%" height="100%" >
  	...
  	<tr>
  		<td><div class="info_box_blue"><div class="meter_text">Clients</div><span class="number"><?php echo $num_rows; ?></span><div class="meter blue"><span style="width: 34%"></span></div></div></td>
  		<td><div class="info_box_green"><div class="meter_text">Produits</div><span class="number"><?php echo $num_rows1; ?></span><div class="meter"><span style="width: 86%"></span></div></div></td>
  		...
  		<td><div class="info_box_marine"><div class="meter_text">Rapports</div><span class="number"><?php echo $num_rows2; ?></span><div class="meter marine"><span style="width: 90%"></span></div></div></td>
  	</tr>
  </table>
</div>
