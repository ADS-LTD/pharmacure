                ...
                <table class="upper_content_forms_table" >
                    ...
                    <tr>
                        ...
                        <td align="center"><select id="typeU" name="typeU">
                            <option value="1" <?php if(isset($view['form']['typeU']) && $view['form']['typeU']==1) echo "selected";?>>Caisse</option>
                            <option value="2" <?php if(isset($view['form']['typeU']) && $view['form']['typeU']==2) echo "selected";?>>Magasinier</option>
                            <option value="3" <?php if(isset($view['form']['typeU']) && $view['form']['typeU']==3) echo "selected";?>>Controleur</option>
                            <option value="4" <?php if(isset($view['form']['typeU']) && $view['form']['typeU']==4) echo "selected";?>>Directeur</option>
                            <option value="5" <?php if(isset($view['form']['typeU']) && $view['form']['typeU']==5) echo "selected";?>>Administrateur</option></select></td>
