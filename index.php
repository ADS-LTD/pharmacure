...
require(ROOT.'controllers/DirecteurSecurity.php');
require(ROOT.'controllers/ControleurSecurity.php');
...
if(method_exists($controller, $action)){
    ...
    if(UserSecurity::Check($controller, $action) && PostSecurity::Check($controller, $action) && AdminSecurity::Check($controller, $action) && IntermediaireSecurity::Check($controller, $action) && DirecteurSecurity::Check($controller, $action) && ControleurSecurity::Check($controller, $action))
    {
        /*
